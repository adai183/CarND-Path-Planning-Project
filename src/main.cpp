      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
            ...
            // Later we will interpolate these waypoints with a spline and fill it with more waypoints.
            vector<double> ptsx;
            vector<double> ptsy;

            // reference x, y, yaw states
            // either we will reference the starting point as where the car is or the previous path's endpoint
            ...
            if (prev_size < 2)
            {
              // use the two points that make the path tangent to the car (go back in time)
            ...
            {
              // redefine reference state as previous path's endpoint
              ...
              // use two pointsthat make the path tangent to the previous path's endpoint
            ...
            // calculate how to breake up spline points to travel at our desired target velocity
            ...
            for (size_t i = 1; i <= 50-previous_path_x.size(); i++)
            {
                ...
                // rotate and shift back to normal (before: we shifted the car reference angle to 0 degrees )
